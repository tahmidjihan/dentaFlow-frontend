...
export default function DoctorPage() {
  ...
  return (
    <div className='min-h-screen flex'>
          ...
          <div className='bg-surface-container-lowest p-4 rounded-xl shadow-sm shadow-on-background/5 border border-outline-variant/10'>
            <div className='flex items-center gap-3'>
              <img
                ...
                src='https://lh3.googleusercontent.com/aida-public/AB6AXuCXKtnRatLULAN9w361Silbvua0RCwcmExv5g05UsN4nU1vcKel73I8wMMv_gQ8rX5Tn7g5tY9-yiRuabDVLh-vIS7DPWwKGgVseQBcZBV063brrw6txf-H8k1Kll6Mq0G-waqZYEb3krEwt0cE7ZXeGiz7mWsuLNU9uQIR-t_YTdqVsHdaebM9JeF1jN1oDPD68B5zHln3OIpxZyRiJtjLhlqu_jGBX2nuSudJR3uSQ_XjT4elmlTQ-etZz-KBMcf7mfewv07JMV4'
                alt='Dr. Sarah Chen'
              />
              <div>
        ...
        <section className='bg-surface-container-lowest rounded-2xl border border-outline-variant/10 shadow-sm overflow-hidden'>
          ...
          <div className='p-8 flex items-center justify-between bg-surface-container-low/10'>
            <span className='text-xs text-outline font-medium'>
              ...
              <span className='text-on-surface font-bold'>128</span>{' '}
              appointments
            </span>
      ...
      <footer className='md:hidden bg-surface-container-lowest fixed bottom-0 w-full px-6 py-4 flex justify-between border-t border-outline-variant/10 z-50'>
        <button className='text-primary flex flex-col items-center gap-1'>
          <span className='material-symbols-outlined'>calendar_today</span>
          <span className='text-[10px] font-bold'>Appts</span>
        </button>
        <button className='text-outline flex flex-col items-center gap-1'>
