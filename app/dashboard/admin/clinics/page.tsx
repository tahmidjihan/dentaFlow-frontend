...
import { useClinics, useCreateClinic, useUpdateClinic, useDeleteClinic } from '@/lib/hooks/use-clinics';
...
export default function ClinicsPage() {
  ...
  const [deletingClinic, setDeletingClinic] = useState<{ id: string; name: string } | null>(null);
                      ...
                      <td className='px-8 py-6 text-right'>
                        <div
                          className={`flex justify-end gap-2 transition-opacity ${
                            hoveredRow === clinic.id ? 'opacity-100' : 'opacity-0'
                          }`}
                        >
                          <button
                          ...
                          <button
                            onClick={() => setDeletingClinic({ id: clinic.id, name: clinic.name })}
